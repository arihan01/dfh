...
const App = () => {
  ...
  const slides = [
    ...
    },
    {
      id: 3,
      content: (
        <div className="flex flex-col items-center justify-center h-full bg-paperG bg-img-3 bg-common">
          <motion.div
    ...
    },
    {
      id: 5,
      content: (
        <div className="flex flex-col items-center justify-center h-full bg-paperG bg-img-5 bg-common">
