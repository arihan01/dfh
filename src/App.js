...
const App = () => {
  ...
  const slides = [
    ...
    },
    {
      id: 4,
      content: (
        <div className="flex flex-col items-center justify-center h-full bg-white bg-img-4 bg-common">
    ...
    },
    {
      id: 8,
      content: (
        <div className="flex flex-col items-center justify-center h-full bg-white bg-img-8 bg-common">
