    ...
    },
    {
      ...
      content: (
        <div className="flex flex-col items-center justify-center h-full white-bg bg-common">
          ...
          <motion.div className='w-3/4 mt-10 mb-5' {...animate.fadeIn} transition={{ ...animate.fadeIn.transition, delay: 0 }}>
            <svgs.s9Text1 className='w-full h-auto' />
          </motion.div>
          <motion.div className='w-3/4 mt-5 mb-5' {...animate.fadeIn} transition={{ ...animate.fadeIn.transition, delay: 0.6 }}>
            <svgs.s9Text2 className='w-full h-auto' />
          </motion.div>
          <motion.div className='w-3/4 mt-5' {...animate.fadeIn} transition={{ ...animate.fadeIn.transition, delay: 1.2 }}>
