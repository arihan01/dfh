...
import { ReactComponent as s2UL } from './img/s2-underline.svg';
import { ReactComponent as s3Text1 } from './img/s3-text-1.svg';
import { ReactComponent as s3Text2 } from './img/s3-text-2.svg';
...
import { ReactComponent as s7Text3 } from './img/s7-2025-text.svg';
import { ReactComponent as s7Text4 } from './img/s7-2026-text.svg';
import { ReactComponent as s8Top } from './img/s8-top.svg';
import { ReactComponent as s8Text1 } from './img/s8-text-1.svg';
...
import { ReactComponent as s8Text1a } from './img/s8-text-1a.svg';
import { ReactComponent as s8Text2a } from './img/s8-text-2a.svg';
import { ReactComponent as s8Text3a } from './img/s8-text-3a.svg';
import { ReactComponent as s9Top } from './img/s9-top.svg';
import { ReactComponent as s9Text1 } from './img/s9-text-1.svg';
import { ReactComponent as s9Text2 } from './img/s9-text-2.svg';
import { ReactComponent as s9Text3 } from './img/s9-text-3.svg';
import { ReactComponent as s10Top } from './img/s10-top.svg';
import { ReactComponent as s11Top } from './img/s11-top.svg';
