...
export default function Slide6() {
  return (
    <div className="white-bg bg-common flex h-screen flex-col items-center justify-center">
      ...
      <motion.div
        className="mb-60 text-center font-cf text-xs md:text-sm w-4/5"
        {...animate.rightToLeft}
      >
        ...
        majestic Kumara Parvatha.<br/><br/> Trek through our ancient forest, where
        300-year-old trees whisper tales, and a vibrant tapestry of endemic
        birds, orchids, butterflies, and rare fungi await. <br/><br/>Let the melody of our
        perennial stream, teeming with life in its purest waters, be your guide
